local function IsVisible(part)
    ...
    local vec, found=workspace.CurrentCamera:WorldToViewportPoint(part.Pocal onscreen = found and vec.Z > 0
...
local Hum = Char:WaitForChild("Humanoid")local function IsVisible(part)
...
local function func(ins)
    ...
    elseif ins.Name=="Shade" and ins.Parent==workspace.CurrentCamera and ins:GetAttribute("ClonedByCrucifix")==nil the
        task.spawn(function()
